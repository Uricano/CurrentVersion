...
(function (root, factory) {
    ...
    chartjs.ScatterNumberScale = chartjs.Element.extend({
        ...
        api: {
            ...
            generateLabels: function (templateString, numberOfSteps, graphMin, stepValue, labels) {
                ...
                if (templateString) {
                    ...
                    helpers.each(labelsArray, function (val, index) {
                        ...
                        if (labels)
                            labelsArray[index] = graphMin + (stepValue * (index)) < labels.length ? labels[graphMin + (stepValue * (index))] : '';
        ...
        calculateXscaleRange: function () {
            ...
            if (this.xScaleOverride) {
                ...
                this.xScaleRange = helpers.calculateScaleRange(
                    ...
                    false,	// beginAtZero,
                    true, // integersOnly
                    true);//set max x value to maxval+1
            }
        },
    ...
    chartjs.ScatterDataSet = (function () {
        ...
        var datasetCtr = function (datasetOptions, chartOptions, chart, scale) {
            ...
            this.pointDot = datasetOptions.pointDot;
            ...
            this.ySelect = chartOptions.ySelect;
            this.xSelect = chartOptions.xSelect
            this.selectPointColor = chartOptions.selectPointColor;

            this.points = [];
        };

        datasetCtr.prototype.addPoint = function (x, y, r, tagLabel, index) {

            // default size
            r = arguments.length < 3 ? 1 : r;

            var isSelect = y == this.ySelect && x == this.xSelect;
            var point = this._createNewPoint(isSelect, index);
            this._setPointData(point, x, y, r);
            point.label = x;
            if (tagLabel != undefined) point.tagLabel = tagLabel;
        ...
        datasetCtr.prototype._createNewPoint = function (isSelect, index) {

            var a = new hlp.ScatterPoint({
                ...
                highlightStroke: isSelect ? this.selectPointColor : this.pointColor,
                fillColor: isSelect ? this.selectPointColor : this.pointColor,
    ...
    chartjs.Type.extend({
        ...
        initialize: function (datasets) {
            ...
            helpers.each(datasets, function (dataset) {
                ...
                helpers.each(dataset.data, function (dataPoint, index) {
                    ...
                    datasetObject.addPoint(dataPoint.x, dataPoint.y, dataPoint.r || 1, dataPoint.tagLabel, index);
                });
        ...
        showTooltip: function (elements) {
            ...
            if (elements.length > 0 && elements[0].display) {
                ...
                if (elements.length == 1) {
                    ...
                    helpers.each(elements, function (point) {
                        ...
                        if (this.options.showMultiToolTip)
