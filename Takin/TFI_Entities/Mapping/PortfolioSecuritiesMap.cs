...
namespace TFI.Entities.Mapping
{
    ...
    public class TblPortfoliosecuritiesMap : ClassMap<PortfolioSecurities>
    {
        public TblPortfoliosecuritiesMap()
        {
			Table("tbl_PortfolioSecurities");
            ...
            Map(x => x.flYesterdayPrice).Column("flYesterdayPrice");
            Map(x => x.flCreationPrice).Column("flCreationPrice");
        }
    }
}
