...
{
    public class Scilab_cs_wrapper
    {
        ...
        private const string CALL_SCILAB_DLL = "C:\\CherriesData\\Engine\\bin\\call_scilab.dll";
        private const string API_SCILAB_DLL = "C:\\CherriesData\\Engine\\bin\\api_scilab.dll";
        private const string GRAPHICS_DLL = "C:\\CherriesData\\Engine\\bin\\graphics.dll";
        private const string OUTPUT_STREAM_DLL = "C:\\CherriesData\\Engine\\bin\\scioutput_stream.dll";

        //private const string CALL_SCILAB_DLL = "C:\\Program Files\\scilab-5.2.2\\bin\\call_scilab.dll";
        //private const string API_SCILAB_DLL = "C:\\Program Files\\scilab-5.2.2\\bin\\api_scilab.dll";
        //private const string GRAPHICS_DLL = "C:\\Program Files\\scilab-5.2.2\\bin\\graphics.dll";
        //private const string OUTPUT_STREAM_DLL = "C:\\Program Files\\scilab-5.2.2\\bin\\scioutput_stream.dll";

        //private const string CALL_SCILAB_DLL = "C:\\Program Files\\scilab-5.3.0\\bin\\call_scilab.dll";
        //private const string API_SCILAB_DLL = "C:\\Program Files\\scilab-5.3.0\\bin\\api_scilab.dll";
        //private const string GRAPHICS_DLL = "C:\\Program Files\\scilab-5.3.0\\bin\\graphics.dll";
        //private const string OUTPUT_STREAM_DLL = "C:\\Program Files\\scilab-5.3.0\\bin\\scioutput_stream.dll";

        //private cScilabDirs m_objDllFolders;
        //private static string sTmp = Cherries.Properties.Settings.Default.ScilabDir.ToString();
        //private const string m_strDllFolder = sTmp;

        #endregion Data members

        #region Constructors, Initialization & Destructor

        public Scilab_cs_wrapper(String strDllFolder)
        { }//constructor
        ...
        /// </summary>
        [DllImport(CALL_SCILAB_DLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </summary>
        [DllImport(API_SCILAB_DLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(GRAPHICS_DLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(OUTPUT_STREAM_DLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
