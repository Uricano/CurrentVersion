...
namespace DotNetScilab
{
    ...
    public sealed class cScilab
    {
        //=============================================================================
        private cEngineDlls m_objScilabInvoker; // Dll methods caller
        static cScilab instance = null;
        ...
        //=============================================================================
        //public cScilab(Boolean _bWithGraphics)
        //{
        //    // Disable TCL/TK and Java graphic interfaces
        //    if (_bWithGraphics == false)
        //    {
        //        cEngineDlls.DisableInteractiveMode();
        //        withGraphics = false;
        //    }
        //    else
        //    {
        ...
        //    // start Scilab engine
        //    cEngineDlls.StartScilab(null, null, null);
        //}
        //=============================================================================
        /// <summary>
        /// Singleton 
        ...
        /// thread safe
        /// </summary>
        public static cScilab Instance
        {
            get
            {
                lock (padlock)
        ...
        //{
        //    System.IntPtr ptrEmpty = new System.IntPtr();
        //    cEngineDlls.api_Err SciErr = cEngineDlls.createNamedComplexMatrixOfDouble(ptrEmpty, matrixName,
        //                                            iRows, iCols,
        //                                            matrixRealPart,
        //                                            matrixImagPart);
        //    return SciErr.iErr;
        ...
        public unsafe double[] readNamedMatrixOfDouble(string matrixName)
        {
            ...
            System.IntPtr ptrEmpty = new System.IntPtr();
            //cEngineDlls.api_Err SciErr = m_objScilabInvoker.readDblMat(ptrEmpty, matrixName, &iRows, &iCols, null);
            ...
            if (iRows * iCols > 0)
            {
                ...
                //SciErr = m_objScilabInvoker.readDblMat(ptrEmpty, matrixName, &iRows, &iCols, matrixDouble);
        ...
        public unsafe int[] getNamedVarDimension(string matrixName)
        {
            ...
            System.IntPtr ptrEmpty = new System.IntPtr();
            //cEngineDlls.api_Err SciErr = m_objScilabInvoker.getVarDimension(ptrEmpty, matrixName, &iRows, &iCols);
        ...
        //        // get values in matrixDouble
        //        cEngineDlls.api_Err SciErr = cEngineDlls.readNamedMatrixOfBoolean(ptrEmpty, matrixName,
        //                                                    &iRows, &iCols,
        //                                                    matrixInt);
        ...
        //        cEngineDlls.api_Err SciErr = cEngineDlls.readNamedComplexMatrixOfDouble(ptrEmpty, matrixName,
        //                                   &iRows, &iCols,
        //                                   dRealPart,
        //                                   dImagPart);
        //    }
        ...
        public unsafe int[] readNamedMatrixOfInt32(string matrixName)
        {
            ...
            if (iDim != null)
            {
                ...
                //cEngineDlls.api_Err SciErr = m_objScilabInvoker.readIntMat(ptrEmpty, matrixName, &iRows, &iCols, matrixInt);
        ...
        //    if (withGraphics)
        //    {
        //        int ierr = cEngineDlls.sciHasFigures();
        ...
        //{
        //    System.IntPtr ptrEmpty = new System.IntPtr();
        //    return cEngineDlls.isNamedVarComplex(ptrEmpty, matrixName);
        //}
        //=============================================================================
    }
}
